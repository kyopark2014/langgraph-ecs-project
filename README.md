...
`installer.py`가 수행하는 작업 (Memory·Session Storage 관련):
...
4. VPC, ALB, **S3 Files 세션 스토리지** (`[5.5/10]`), ECS Fargate(S3 Files `/mnt/workspace` 마운트), Knowledge Base, AgentCore Web Search Gateway 등 인프라 배포
